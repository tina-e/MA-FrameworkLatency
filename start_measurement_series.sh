...
./start_measurements_sep.sh calibrate_and_measure $ITERATIONS DirectX11 default False getpixel $DATA_DIR
...
# ./start_measurement.sh calibrate_and_measure $ITERATIONS SDL2_Software default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS SDL2_Software default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS SDL2_Software rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS SDL2_Software rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS SDL2_OPENGL default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS SDL2_OPENGL default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS SDL2_OPENGL rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS SDL2_OPENGL rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS SDL2_OpenGLES default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS SDL2_OpenGLES default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS SDL2_OpenGLES rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS SDL2_OpenGLES rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS pygame default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS pygame default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS pygame rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS pygame rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS wxpython default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS wxpython default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS wxpython rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS wxpython rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS pyqt5 default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS pyqt5 default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS pyqt5 rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS pyqt5 rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS pyqt6 default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS pyqt6 default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS pyqt6 rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS pyqt6 rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS tkinter default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS tkinter default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS tkinter rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS tkinter rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS JavaSwing default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS JavaSwing default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS JavaSwing rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS JavaSwing rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS Java2D default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS Java2D default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS Java2D rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS Java2D rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS pyglet default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS pyglet default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS pyglet rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS pyglet rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS GLUT default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS GLUT default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS GLUT rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS GLUT rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS FLTK default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS FLTK default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS FLTK rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS FLTK rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS win32 default True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS win32 default False windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS win32 rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS win32 rects False windup $DATA_DIR
...
# ./start_measurement.sh measure $ITERATIONS GLEW rects True windup $DATA_DIR
# ./start_measurement.sh measure $ITERATIONS GLEW rects False windup $DATA_DIR
