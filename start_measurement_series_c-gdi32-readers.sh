...
# # # pygame ---------------------------------------------------------------------------------------
./start_measurement.sh calibrate_and_measure $ITERATIONS pygame default True getpixel $DATA_DIR
...
# # SDL2 ---------------------------------------------------------------------------------------
./start_measurement.sh measure $ITERATIONS SDL2_Software default True getpixel $DATA_DIR
