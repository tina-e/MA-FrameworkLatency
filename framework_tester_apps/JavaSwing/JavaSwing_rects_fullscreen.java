...
public class JavaSwing_rects_fullscreen extends JFrame {
    private Color color;
    private static final int WIDTH = 1920;
    private static final int HEIGHT = 1080;
    private static final int MIN_X_RECTS = WIDTH / 2;

    public JavaSwing_rects_fullscreen() {
    ...
    public static void main(String[] args) {
        JavaSwing_rects_fullscreen window = new JavaSwing_rects_fullscreen();
